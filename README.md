...
Version 2.5 is published as a separate web application in `v2/`.
...
- Applies the Version 2.5 EQ rules from the `20260525e` task: fixed Band Fc values and Band Target values split from XML EQ band lists.
